...
signed main() {
	FASTIO();
	gvs(v, 10);
	rep(i, 0, 4) rep(j, 0, 3) cnt += chk[2*i][j] = v[3*i][1+3*j] == '-';
	rep(i, 0, 3) rep(j, 0, 4) cnt += chk[2*i+1][j] = v[3*i+1][3*j] == '|';

	rep(i, 0, 3) rep(j, 0, 3) sqa += chk[2*i][j]&chk[2*i+1][j]&chk[2*i+1][j+1]&chk[2*i+2][j];
	rep(i, 0, 2) rep(j, 0, 2) sqa += chk[2*i][j]&chk[2*i][j+1]&chk[2*i+1][j]&chk[2*i+3][j]&chk[2*i+1][j+2]&chk[2*i+3][j+2]&chk[2*i+4][j]&chk[2*i+4][j+1];
	sqa += chk[0][0]&chk[0][1]&chk[0][2]&chk[1][0]&chk[1][3]&chk[3][0]&chk[3][3]&chk[5][0]&chk[5][3]&chk[6][0]&chk[6][1]&chk[6][2];
	pf2(24-cnt, sqa);
}