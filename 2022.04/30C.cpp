////////////////////////////////////////
//   Today : Sat Apr 30 09:06:50 2022 //
//  Author : rasauq1122               //
// Problem : BOJ16965                 //
////////////////////////////////////////
...
bool dfs(int idx, int goal) {
    ...
    repe(i, 1, cnt) {
        if (!vis[i] && chk(seg[idx], seg[i]) && dfs(i, goal)) return 1;
    }
...
signed main() {
    ...
    rep(i, 0, n) {
        ...
        if (t == 1) seg.pb({a, b}), cnt++;
        else vis = vi(cnt+1), cout << dfs(a, b) << endl;
    } 
}