...
// WH + W(H-1)*2 + W(H-2)*3 + ...
// (W-1)H*2 + (W-1)(H-1)*4 + (W-1)(H-2)*6 + ...
// (W-2)H*3 + (W-2)(H-1)*6 + (W-2)(H-2)*9
// + ...
...
// (H + 2*(H-1) + 3*(H-2) + ...)(W + 2*(W-1) + 3*(W-2) + ...)
// (H + 2(H-1) + 3(H-2) + ... + H(H-(H-1)))(W + 2(W-1) + 3(W-2) + ... W(W-(W-1)))
// (H(1 + 2 + ... + H) - H(H-1)(2H-1)/6 - H(H-1)/2)(W(1 + 2 + ... + W) - W(W-1)(2W-1)/6 - W(W-1)/2)
// (H*H(H+1)/2 - H(H-1)(2H-1)/6 - H(H-1)/2)(W*W(W+1)/2 - W(W-1)(2W-1)/6 - W(W-1)/2)
