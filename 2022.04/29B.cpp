////////////////////////////////////////
//   Today : Fri Apr 29 23:09:55 2022 //
//  Author : rasauq1122               //
// Problem : BOJ6884                  //
////////////////////////////////////////
...
signed main() {
    ...
    repe(i, 2, 10000) {
        if (!np[i]) {
            p.pb(i);
            for (int j = 2*i ; j <= 10000 ; j += i) np[j] = true;
        }
    }
    const string YES = "Shortest primed subsequence is length ";
    const string NO = "This sequence is anti-primed.";
    TC() {
        int n;
        cin >> n;
